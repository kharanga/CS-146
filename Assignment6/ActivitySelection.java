...
public class ActivitySelection {
	...
	/**
	 * Returns the maximal possible list of activities that do not overlap with each other.
	 ...
	 * @return The highest sum of weights for any list of Activities that do not overlap
	 */
	 ...
	 * and also do not overlap with each other!
	 * @return The list of the Activities that were chosen with the highest sum of weights.
	 */
	public List<Activity> selectActivitiesDynamic_listMaxSumWeights() {
		...
		List<Activity> flipMaxWeightList = new ArrayList<Activity>();
		...
		for(int i = n; i>=1; i--) {
			if(optimalWeightsum[i] > optimalWeightsum[i-1]) {
				flipMaxWeightList.add(activities.get(i-1));
				i = lastfinishingjob[i-1]+2;
			}
		}
		for(int i = flipMaxWeightList.size()-1; i>=0; i--) {
			maxWeightList.add(flipMaxWeightList.get(i));
		}
	...
	public static void main(String[] args) {
		 ...
		 * Check that the maximal number of activities that do not overlap is returned.
		...
		/**
		 * Check that the correct activity list that maximizes the sum of weights is returned.
		 */
		List<Activity> list2 = select.selectActivitiesDynamic_listMaxSumWeights();
